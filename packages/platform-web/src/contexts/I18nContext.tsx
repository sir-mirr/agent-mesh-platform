...
export const DICTIONARY: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    "dash.group.sub": "Group agent memberships, socketless lease queue, and inter-group messaging",
    "dash.operator.title": "Owned Agent Fleet Dashboard",
    "dash.operator.sub": "Owned Ed25519 agent connections, socketless lease queue, and message tests",

    "dash.pa.nodes": "Total Agent Nodes",
    "dash.pa.nodesSub": "10-Group Galaxy",
    ...
    "dash.pa.latencySub": "SLA 99.99% Normal",
    ...
    "dash.ta.agentsSub": "3 Active, 1 Socketless",
    "dash.ta.egress": "Egress Allow Rules",
    "dash.ta.egressSub": "Deny-by-default",
    "dash.ta.approval": "Pending Key Approvals",
    "dash.ta.approvalSub": "Action required",
    ...
    "dash.ga.lease": "Lease Queue Pending",
