...
const MUTATIONS: Mutation[] = [
  ...
  },
  {
    ...
    defect: "the overview stops passing the failure through, so the screen that summarises the whole platform prints its healthy sentence about a backend that never answered. The banner and the panels then disagree on the same page, which is the contradiction this scenario exists for.",
