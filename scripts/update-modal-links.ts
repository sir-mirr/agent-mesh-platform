...
// Build clean 60-screen modal HTML
const catalogHtml = `
      <div style="padding:24px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
          <div>
            <h2 style="font-size:1.25rem; font-weight:800;">Agent Mesh Platform — 60 Enterprise Screen Catalog</h2>
            <p style="font-size:0.8rem; color:var(--text-secondary); margin-top:2px;">Complete modular breakdown across all 5 operational suites</p>
          </div>
          <button onclick="document.getElementById('screenCatalogModal').style.display='none'" style="background:none; border:none; font-size:1.4rem; cursor:pointer; color:var(--text-secondary);">&times;</button>
        </div>
        ...
        <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:8px; margin-bottom:20px;">
          <a href="/platform/index.html" class="subnav-pill" style="display:block;">#9 Operator Overview Matrix</a>
          ...
          <a href="/platform/telemetry.html" class="subnav-pill" style="display:block;">#13 Node CPU, RAM & Sockets</a>
          ...
          <a href="/platform/metadata-audits.html" class="subnav-pill" style="display:block;">#16 Egress Redacted Audits</a>
          <a href="/platform/gateway-inspect.html" class="subnav-pill" style="display:block;">#17 Gateway Node Inspector</a>
          <a href="/platform/bandwidth-shaper.html" class="subnav-pill" style="display:block;">#18 Highway Bandwidth QoS</a>
        ...
        <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:8px; margin-bottom:20px;">
          ...
          <a href="/tenant/group-detail.html" class="subnav-pill" style="display:block;">#26 Core Swarm Detail & Owners</a>
        ...
        <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:8px;">
          ...
          <a href="/dev/api-outbox.html" class="subnav-pill" style="display:block;">#51 POST & GET /outbox API</a>
          <a href="/dev/api-inbox.html" class="subnav-pill" style="display:block;">#52 POST /inbox (SPEC §8.10)</a>
          <a href="/dev/api-outbox-delete.html" class="subnav-pill" style="display:block;">#53 DELETE /outbox/{id}</a>
          <a href="/dev/api-inbox-history.html" class="subnav-pill" style="display:block;">#54 GET /inbox/history</a>
          <a href="/dev/api-agents-provision.html" class="subnav-pill" style="display:block;">#55 POST /agents (Provision/Key)</a>
          <a href="/dev/api-capabilities.html" class="subnav-pill" style="display:block;">#56 GET /capabilities (v4)</a>
          <a href="/dev/sdk-typescript.html" class="subnav-pill" style="display:block;">#57 TypeScript SDK Guide</a>
          <a href="/dev/sdk-python.html" class="subnav-pill" style="display:block;">#58 Python SDK Guide</a>
          <a href="/dev/sdk-go.html" class="subnav-pill" style="display:block;">#59 Go SDK Guide</a>
          <a href="/dev/webhooks.html" class="subnav-pill" style="display:block;">#60 Webhook Subscriptions</a>
        </div>
      </div>
`;

const startIdx = html.indexOf('<div style="padding:24px;">');
const endIdx = html.indexOf('</div>\n    </div>\n  </div>\n\n</body>');

if (startIdx !== -1 && endIdx !== -1) {
  html = html.slice(0, startIdx) + catalogHtml + html.slice(endIdx + 6);
  writeFileSync(filePath, html, 'utf-8');
  console.log('Successfully updated modal in preview/index.html!');
} else {
  console.error('Could not find modal boundary in preview/index.html');
}
